...
r.style.setProperty('--screenwidth', window.screen.width + 'px');
r.style.setProperty('--screenheight', window.screen.height + 'px');

var logo = document.getElementById("logo")
var menu = document.getElementById("menu-symbol")
var text = document.getElementById("navbar-main-text")
if(isMobileDevice()){  /*  If mobile site sizing navbar will be done here  */
    ...
    index = index - 1
    logo.setAttribute("style","width:" + index*2 + "px;height:" + index*2 + "px;visibility: visible;");
    menu.setAttribute("style","width:" + index*2 + "px;height:" + index*2 + "px;visibility: visible;");
    text.setAttribute("style","font-size:" + index + "px;visibility: visible;");
}
else{  /*  Set visibility for desktop site. Initially hidden  */
